            ...
            <div className="space-y-4">
              {SOCIALS.map((s) => (
                <a
                  ...
                  className="group flex items-center gap-4 p-4 rounded-2xl border border-white/8 bg-white/[0.03] hover:border-accent-cyan/40 hover:bg-white/[0.05] transition-all duration-300"
                >
                  <span className="flex items-center justify-center w-11 h-11 rounded-xl bg-white/5 text-accent-cyan group-hover:scale-110 group-hover:bg-accent-cyan/10 transition-all duration-300">
          ...
          >
            {status === "success" ? (
              <motion.div
                ...
                className="h-full min-h-[300px] flex flex-col items-center justify-center text-center gap-3 text-accent-cyan"
              >
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={field.name} className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-muted-dim focus:border-accent-cyan/60 focus:bg-white/[0.06] outline-none transition-all"
                    />
                  </div>
                ))}
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-muted-dim focus:border-accent-cyan/60 focus:bg-white/[0.06] outline-none transition-all resize-none"
                  />
                </div>
                <motion.button
                  type="submit"
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full inline-flex items-center justify-center gap-2 bg-white text-ink-900 font-semibold px-6 py-3.5 rounded-full hover:bg-accent-cyan transition-colors duration-300 disabled:opacity-70"
                >
                  {status === "submitting" ? (
